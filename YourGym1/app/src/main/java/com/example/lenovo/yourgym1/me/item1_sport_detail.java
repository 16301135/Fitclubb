...
public class item1_sport_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.me_item1_sport_detail);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Toast.makeText(item1_sport_detail.this,"onItemClick",Toast.LENGTH_SHORT).show();
                Intent intent_v = new Intent(item1_sport_detail.this, videoPlay.class);
